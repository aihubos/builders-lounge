import "./platform.js?v=20260824-shorts-studio";
...
import { mountShorts } from "./shorts.js?v=20260824-shorts-studio";
...
const viewMeta = Object.freeze({
  ...
  shorts: { kicker: "만들기", title: "AI 쇼츠 스튜디오", description: "한 문장을 실제 세로형 WebM 영상으로 만들고, 완성 뒤 선택해 게시합니다.", status: "영상 완성 시 Build 5" },
...
function getNoticeCopy(view = document.documentElement.dataset.loungeRoute || "home") {
  ...
  if (view === "shorts") return "한 문장을 제작안으로 확장해 실제 세로형 WebM 영상을 만들고, 완성 뒤 게시 여부를 직접 선택합니다.";
